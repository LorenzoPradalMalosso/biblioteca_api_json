...
O Escopo atual inclui operações básica de gerenciamento de dados persistidos em um backend simulado via json-server.
...
| RF04 | Navegação | Interface com Navegação por abas |

### 3.2 Requisitos Não Funcionais (RNF)

| ID | Requisito | Descrição |
| - | - | - |
| RNF01 | Arquitetura | Baseada em Camadas (Model, Serice, Controller, View) seguindo o padrão MVC |
...
| PUT | /users/{id} | Atuaçoza um usuário |
